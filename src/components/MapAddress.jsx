    ...
    >
      ...
      <div className="max-w-6xl w-full mx-auto relative z-10 flex flex-col gap-12 sm:gap-14">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
          ...
          <div
            className="lg:col-span-7 rounded-2xl overflow-hidden relative min-h-[360px] sm:min-h-[400px]"
            style={{
          ...
          <div
            className="lg:col-span-5 p-8 sm:p-10 rounded-2xl flex flex-col justify-between gap-8"
            style={{
